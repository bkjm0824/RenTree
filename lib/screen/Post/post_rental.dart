...
class _PostRentalScreenState extends State<PostRentalScreen> {
                            ...
                            children: [
                              ...
                              Text(
                                room['lastMessageDate'] != null
                                    ? formatTimeDifference(DateTime.tryParse(
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        final imageRes = await http.get(Uri.parse(
            'http://54.79.35.255:8080/images/api/item/${widget.itemId}'));
  ...
  Future<void> _deletePost() async {
    final url =
        Uri.parse('http://54.79.35.255:8080/rental-item/${widget.itemId}');
